...
const Counter = ({ to, suffix = "" }: { to: number; suffix?: string }) => {
  ...
  return (
    <div
      ref={ref}
      className="font-display font-bold text-4xl md:text-5xl gradient-text"
    >
      {n}
      {suffix}
    </div>
    ...
    <div className="container">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
        {achievements.map((a) => (
          <div
            key={a.label}
            className="reveal glass rounded-2xl p-6 text-center hover:-translate-y-1 transition-transform"
          >
